...
namespace Mzg.DataMapping
{
    ...
    public class ServiceRegistrar : IServiceRegistrar
    {
        ...
        public void Add(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<DataMapping.Data.IAttributeMapRepository, DataMapping.Data.AttributeMapRepository>();
            services.AddScoped<DataMapping.Data.IEntityMapRepository, DataMapping.Data.EntityMapRepository>();
        }
    }
}