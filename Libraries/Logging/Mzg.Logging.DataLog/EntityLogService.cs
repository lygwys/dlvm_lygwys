...
using Mzg.Logging.DataLog.Data;
    ...
    public class EntityLogService : IEntityLogService
    {
        ...
        public bool UpdatedLog(Entity originData, Entity newData, Schema.Domain.Entity entityMetadata, List<Schema.Domain.Attribute> attributeMetadatas)
        {
            ...
            foreach (var item in newData)
            {
                ...
                //{
                //    var attr = attributeMetadatas.Find(n => n.Name.IsCaseInsensitiveEqual(item.Key));
                //    if (!item.Key.IsCaseInsensitiveEqual("createdon") && !item.Key.IsCaseInsensitiveEqual(
                //                                                          "createdby")
                //                                                      && !item.Key.IsCaseInsensitiveEqual(
                //                                                          "modifiedon") &&
                //                                                      !item.Key.IsCaseInsensitiveEqual("modifiedby")
                //                                                      && !item.Key.IsCaseInsensitiveEqual(
                //                                                          "versionnumber"))
                //    {
                //        if (attr != null && (attr.TypeIsText() || attr.TypeIsNText()))
                ...
                //        {
                //            Name = item.Key,
                //            Original = originData[item.Key].ToString(),
                ...
                // 202006061039
                var originValue = "";
                if (originData.TryGetValue(item.Key, out var value))
                {
                    if (value != null)
                    {
