...
namespace Mzg.Organization
{
    ...
    public class SystemUserService : ISystemUserService
    {
        ...
        {
            return _repository.Find(x => (x.LoginName == loginName || x.MobileNumber == loginName));
        }
        ...
        public SystemUser GetUserByLoginNameAndPassword(string loginName, string password, string salt = "")
        {
            ...
            return _repository.Find(x => (x.LoginName == loginName || x.MobileNumber == loginName) && x.Password == password);
        }
