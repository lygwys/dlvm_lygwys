...
!function (factory) {
    ...
    if (typeof Xms === 'undefined') {
        throw Error('mzg不能为空， 请先引用mzg.js文件 ');
    }
    ...
    function getTreeData(opts, callback) {
        ...
        Dlv.web.GetJson(url, data, function (response) {
    ...
    */
    ...
    function treeFilterGridView(item, entityname, parent, attrname, sortby, data) {
        ...
        filter.FilterOperator = Dlv.Fetch.LogicalOperator.Or;
        condition.AttributeName = attrname;
        condition.Operator = Dlv.Fetch.ConditionOperator.In;
