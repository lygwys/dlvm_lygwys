...
//models
Dlv.Form.FormDescriptor = function () {
    var self = new Object();
    self.Name = '';
    self.Description = '';
    self.IsShowNav = true;
...
Dlv.Form.NavGroupDescriptor = function () {
    var self = new Object();
    self.Label = '';
    self.IsVisible = true;
    self.NavItems = [];
...
//表单设计中导航链接中的成员变量设置 ,在renderform.js中方可使用navlinkModel.Fun
//mzg
//202012011105
Dlv.Form.NavDescriptor = function () {
    var self = new Object();
    self.Id = Dlv.Utility.Guid.NewGuid().ToString();
    self.Label = '';
    self.IsVisible = true;
    self.Icon = '';
    self.Url = '';
...
Dlv.Form.PanelDescriptor = function () {
    var self = new Object();
    self.Id = Dlv.Utility.Guid.NewGuid().ToString();
...
Dlv.Form.SectionDescriptor = function () {
    var self = new Object();
    self.Id = Dlv.Utility.Guid.NewGuid().ToString();
    self.Name = '';
    self.Label = '';
...
Dlv.Form.RowDescriptor = function () {
    var self = new Object();
    self.IsVisible = true;
    self.Cells = [];
    return self;
};
Dlv.Form.CellDescriptor = function () {
    var self = new Object();
    self.Id = Dlv.Utility.Guid.NewGuid().ToString();
    self.Label = '';
    self.IsShowLabel = true;
    ...
    self.ColSpan = 0;
    self.RowSpan = 0;
    self.Control = new Dlv.Form.ControlDescriptor();
    return self;
};
Dlv.Form.ControlDescriptor = function () {
    var self = new Object();
    self.Name = '';
    self.EntityName = '';
    self.ControlType = Dlv.Form.FormControlType.standard;
    self.ReadOnly = false;
    self.Parameters = null;
    self.Formula = null;
    return self;
};
Dlv.Form.ExtendPropertyParameters = function () {
    var self = new Object();
...
Dlv.Form.SubGridParameters = function () {
    var self = new Object();
    self.ViewId = null;
    self.PageSize = 5;
...
Dlv.Form.SubGridFormulars = function () {
    var self = new Object();
    self.name = '';
    self.type = '';
    self.expression = '';
...
Dlv.Form.LookUpParameters = function () {
    var self = new Object();
...
Dlv.Form.IframeParameters = function () {
    var self = new Object();
    self.Url = null;
    self.Border = null;
    self.Scroll = null;
...
Dlv.Form.PresentationParameters = function () {
    var self = new Object();
    self.ItemColor = null;
    self.Series = [];
    return self;
};
Dlv.Form.ChartsParameters = function () {
    var self = new Object();
    self.Type = null;
    self.Fetch = [];
    return self;
};
Dlv.Form.ChartsAxisParameters = function () {
    var self = new Object();
    self.Attribute = null;
    self.Type = null;
    self.Aggregate = null;
...
Dlv.Form.WebSourceParameters = function () {
    var self = new Object();
    return self;
};
Dlv.Form.EventDescriptor = function () {
    var self = new Object();
    self.Name = '';
...
//const
Dlv.AttributeFormat = function () { };
Dlv.AttributeType = function () { };
Dlv.BooleanFormat = function () { };
Dlv.ControlType = function () { };
Dlv.FormSaveAction = function () { };
Dlv.RequiredLevel = function () { };
Dlv.SubmitMode = function () { };
Dlv.TabDisplayState = function () { };
Dlv.AttributeFormat.dateFormat = "date";
Dlv.AttributeFormat.dateTimeFormat = "datetime";
Dlv.AttributeFormat.durationFormat = "duration";
Dlv.AttributeFormat.emailFormat = "email";
Dlv.AttributeFormat.languageFormat = "language";
Dlv.AttributeFormat.noneFormat = "none";
Dlv.AttributeFormat.textFormat = "text";
Dlv.AttributeFormat.textAreaFormat = "textarea";
Dlv.AttributeFormat.tickerSymbolFormat = "tickersymbol";
Dlv.AttributeFormat.timeZoneFormat = "timezone";
Dlv.AttributeFormat.urlFormat = "url";
Dlv.AttributeType.booleanType = "boolean";
Dlv.AttributeType.dateTimeType = "datetime";
Dlv.AttributeType.decimalType = "decimal";
Dlv.AttributeType.doubleType = "double";
Dlv.AttributeType.integerType = "integer";
Dlv.AttributeType.lookupType = "lookup";
Dlv.AttributeType.memoType = "memo";
Dlv.AttributeType.moneyType = "money";
Dlv.AttributeType.optionSetType = "optionset";
Dlv.AttributeType.stringType = "string";
Dlv.BooleanFormat.checkBox = "checkbox";
Dlv.BooleanFormat.dropDown = "dropdown";
Dlv.BooleanFormat.radioButton = "radiobutton";
Dlv.ControlType.hidden = "hidden";
Dlv.ControlType.iFrame = "iframe";
Dlv.ControlType.lookup = "lookup";
Dlv.ControlType.none = "none";
Dlv.ControlType.optionSet = "optionset";
Dlv.ControlType.standard = "standard";
Dlv.ControlType.subGrid = "subgrid";
Dlv.ControlType.webResource = "webresource";
Dlv.FormSaveAction.save = "save";
Dlv.FormSaveAction.saveAndClose = "saveandclose";
Dlv.FormSaveAction.saveAndNew = "saveandnew";
Dlv.RequiredLevel.none = "none";
Dlv.RequiredLevel.recommended = "recommended";
Dlv.RequiredLevel.required = "required";
Dlv.SubmitMode.dirty = "dirty";
Dlv.SubmitMode.always = "always";
Dlv.SubmitMode.never = "never";
Dlv.TabDisplayState.collapsed = "collapsed";
Dlv.TabDisplayState.expanded = "expanded";

Dlv.Form.RenderCell = function (columns, fill) {
...
Dlv.Form.RenderControl = function (columns, _cell, value, onlyLabel) {
    ...
    if (_cell.Control.ControlType == Dlv.Form.FormControlType.subGrid || _cell.Control.ControlType.toLowerCase() == 'subgrid') {
    ...
    else if (_cell.Control.ControlType == Dlv.Form.FormControlType.iFrame || _cell.Control.ControlType.toLowerCase() == 'iframe') {
    ...
    else if (_cell.Control.ControlType == Dlv.Form.FormControlType.webResource || _cell.Control.ControlType.toLowerCase() == 'webresource') {
    ...
    else if (_cell.Control.ControlType == Dlv.Form.FormControlType.none || _cell.Control.ControlType.toLowerCase() == 'none') {
    }
    else {
...
Dlv.Form.RenderSubGrid = function (columns, _cell, value) {
    var _html = [];
}
//create a form
Dlv.Form.CreateForm = function (_form, _record, _container) {
    var _html = new Array();
    if (_form.IsShowNav) {
        //render nav
    }
        ...
        $(_headerSection.Rows).each(function (i, _row) {
            ...
            $(_row.Cells).each(function (j, _cell) {
                ...
                if (_record && _record != null
                    && (_cell.Control.ControlType == Dlv.Form.FormControlType.standard || _cell.Control.ControlType == Dlv.Form.FormControlType.lookup
                ...
                _header.push(Dlv.Form.RenderControl(_headerSection.Columns, _cell, value, true));
            });
            if (_headerSection.Columns - _row.Cells.length > 0) {
                _header.push(Dlv.Form.RenderCell(_headerSection.Columns, _headerSection.Columns - _row.Cells.length));
            }
            _header.push('</tr>');
        });
        _header.push('</table>');
            ...
            $(_tab.Sections).each(function (b, _section) {
                ...
                $(_section.Rows).each(function (c, _row) {
                    ...
                    $(_row.Cells).each(function (d, _cell) {
                        ...
                        _body.push(Dlv.Form.RenderControl(_section.Columns, _cell, value));
                        colspanCount += _cell.ColSpan;
                    });
                    var fillCount = _section.Columns - (_row.Cells.length + colspanCount);
                    if (fillCount > 0) {
                        _body.push(Dlv.Form.RenderCell(_section.Columns, fillCount));
                    }
                    _body.push('</tr>');
                });
                _body.push('</table>');
    ...
    if (_footerSection != null) {
        ...
        $(_footerSection.Rows).each(function (i, _row) {
            ...
            $(_row.Cells).each(function (j, _cell) {
                ...
                _footer.push(Dlv.Form.RenderControl(_footerSection.Columns, _cell, value, true));
            });
            if (_footerSection.Columns - _row.Cells.length > 0) {
                _footer.push(Dlv.Form.RenderCell(_footerSection.Columns, _footerSection.Columns - _row.Cells.length));
            }
            _footer.push('</tr>');
        });
        _footer.push('</table>');
...
Dlv.Form.CreateFormDiv = function (_form, _record, _container) {
    var _html = new Array();
    if (_form.IsShowNav) {
        //render nav
    }
    ...
    if (_headerSection != null) {
        ...
        $(_headerSection.Rows).each(function (i, _row) {
            ...
            $(_row.Cells).each(function (j, _cell) {
                ...
                _header.push(Dlv.Form.RenderControlDiv(_headerSection.Columns, _cell, value, true, null, null, true));
            });
            if (_headerSection.Columns - _row.Cells.length > 0) {
                _header.push(Dlv.Form.RenderCell(_headerSection.Columns, _headerSection.Columns - _row.Cells.length));
            }
            ...
            $(_tab.Sections).each(function (b, _section) {
                ...
                $(_section.Rows).each(function (c, _row) {
                    ...
                    $(_row.Cells).each(function (d, _cell) {
                        ...
                        // 每个字段循环加入，在加入前进行格式化操作
                        _body.push(Dlv.Form.RenderControlDiv(_section.Columns, _cell, value, undefined, _section, _tab));
                        colspanCount += _cell.ColSpan;
                    });
                    var fillCount = _section.Columns - (_row.Cells.length + colspanCount);
                    if (fillCount > 0) {
    ...
    if (_footerSection != null && _footerSection.IsVisible) {
        ...
        $(_footerSection.Rows).each(function (i, _row) {
            ...
            $(_row.Cells).each(function (j, _cell) {
                ...
                _footer.push(Dlv.Form.RenderControlDiv(_footerSection.Columns, _cell, value, true, null, null, true));
            });
            if (_footerSection.Columns - _row.Cells.length > 0) {
                _footer.push(Dlv.Form.RenderCell(_footerSection.Columns, _footerSection.Columns - _row.Cells.length));
            }
...
Dlv.Form.RenderCellDiv = function (columns, fill) {
    var _control = new Array();
    for (var i = 1; i <= fill; i++) {
...
Dlv.Form.getTabIsAsync = function (tabs) {
    var index = -1;
...
Dlv.Form.RenderControlDiv = function (columns, _cell, value, onlyLabel, _section, _tab, isheaderfooter) {
    // if (!pos) return false;
    var labelWidth = '115';
    ...
    var issubgrid = (_cell.Control.ControlType == Dlv.Form.FormControlType.subGrid || _cell.Control.ControlType.toLowerCase() == 'subgrid');
    var _subgirdCl = '';
    if (issubgrid) {
        ...
        switch (attrType) {
            ...
            case "money":
                if (onlyLabel) {
                    ...
                    var range = ' data-range="[' + _cell.Control.AttributeMetadata.MinValue + ',' + _cell.Control.AttributeMetadata.MaxValue + ']"';
                    _control.push('<input type="text" autocomplete="off" class="dirtylisten form-control extParamEnti input-sm money' + required + ' ' + isvalidate + '" name="' + _cell.Control.Name.toLowerCase() + '" id="' + _cell.Control.Name.toLowerCase() + '" data-attributeid="' + attrId + '" data-controltype="' + attrType + '" data-type="number"' + range + ' data-onlylabel="' + onlyLabel + '" data-localizedname="' + localizedname + '" value="' + ConvertMtoT(value) + '"' + readonly + extParamStr + ' />');
                    dirtyChecker.addWatch(_cell.Control.Name.toLowerCase(), value);
                }
                break;
            case "datetime":
            ...
            case  "partylist"://多选类型
                ...
                if (onlyLabel) {
                    ...
                    //把text设置为只读
                    _control.push('<input type="text" autocomplete="off" class="nodirty form-control input-sm extParamEnti lookup' + required + ' ' + isvalidate + '" name="' + _cell.Control.Name.toLowerCase() + '_text" id="' + _cell.Control.Name.toLowerCase() + '_text" data-attributeid="' + attrId + '" data-controltype="' + attrType + '" data-lookup="' + _cell.Control.AttributeMetadata.ReferencedEntityId + '" data-relationshipname="' + ((_cell.Control.Parameters && _cell.Control.Parameters.RelationshipName) || '') + '" data-defaultviewid="' + ((_cell.Control.Parameters && _cell.Control.Parameters.DefaultViewId) || '') + '" data-FilterRelationshipName="' + FilterRelationshipName + '" data-DependentAttributeName="' + DependentAttributeName + '" data-DependentAttributeType="' + DependentAttributeType + '" data-AllowFilterOff="' + AllowFilterOff + '" data-value="' + value + '" data-onlylabel="' + onlyLabel + '" data-localizedname="' + localizedname + '"' + readonly + extParamStr + isorg + '  disabled />');

                    //隐藏域设置为字符型
                    _control.push('<input type="hidden" class="dirtylisten haslookup' + required + ' ' + isvalidate + '" name="' + _cell.Control.Name.toLowerCase() + '" id="' + _cell.Control.Name.toLowerCase() + '" data-attributeid="value_' + attrId + '" data-controltype="' + attrType + '" data-type="text" value="' + value + '" data-lookup="' + _cell.Control.AttributeMetadata.ReferencedEntityId + '" data-relationshipname="' + ((_cell.Control.Parameters && _cell.Control.Parameters.RelationshipName) || '') + '" data-defaultviewid="' + ((_cell.Control.Parameters && _cell.Control.Parameters.DefaultViewId) || '') + '" data-localizedname="' + localizedname + '" />');
                    dirtyChecker.addWatch(_cell.Control.Name.toLowerCase(), value);
                }
                break;
            case "owner":
