...
var Datagrid_page = function (GridViewModel, gridModel, sumsColumn) {
    ...
    var urlConfig = {
        getData: 'rendergridview?entityid=' + Dlv.Page.PageContext.entityid + '&onlydata=true&pagesize' + 20 + '&page=' + 1
    }
        ...
        },
        {
            ...
            listeners: [{
                click: function (a, b) {
                    ...
                    var rowdata = { rowData: {} };
                    rowdata.rowData[primarykey] = Dlv.Utility.Guid.NewGuid().ToString('N');
