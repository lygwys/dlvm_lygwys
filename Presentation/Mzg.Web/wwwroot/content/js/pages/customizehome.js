...
!function (factory) {
    ...
    var customhome = new function () {
        ...
        this.loadParentDatas = function () {
            var datas = Dlv.web.callParentMethod('xms_navGetAllDatas');
            this.solutionid = Dlv.web.callParentMethod('getPageSolutionId');
            return datas;
        }
        //加载初始化设置
        ...
        this.bindShortCutList = function (datas) {
            ...
            $shortcutList.on('click', '.shortcut-item', function (e) {
                ...
                if (self.shortcutDatas && self.shortcutDatas.length > 0) {
                    ...
                    if (index != -1) {
                        Dlv.web.callParentMethod('triggerLink', self.shortcutDatas[index])
                        //triggerLink();
                    }
                }
            })
        ...
        this.loadSystemInfo = function () {
            Dlv.web.Get(ORG_SERVERURL + '/api/serverhostmanage/getSystemInfomation', function (res) {
                console.log(res);
