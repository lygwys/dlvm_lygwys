...
(function ($, root, un) {
    ...
    function elePoint(name, opts) {
        ...
        this.WorkFlowStepId = this.param.WorkFlowStepId ? this.param.WorkFlowStepId : Dlv.Utility.Guid.NewGuid().ToString('D');
...
function loadEntities(callback) {
    Dlv.web.GetJson('/api/schema/entity/' + Dlv.Page.PageContext.EntityId, null, function (data) {
        if (!data) return;
...
function resetFlowCnName(entityid, callback, type) {
    if (!type) {
        ...
        Dlv.web.PageCache('workflow', '/api/schema/attribute?getall=true&entityid=' + entityid + '', params, function (data) {
        ...
        Dlv.web.PageCache('workflow', '/api/schema/relationship/GetReferenced/', enParam, function (result) {
...
function loadWorkFlowInstances(callback) {
    Dlv.web.GetJson('/api/workflow/instances?entityid=' + Dlv.Page.PageContext.EntityId + '&recordid=' + Dlv.Page.PageContext.RecordId, {}, function (res) {
