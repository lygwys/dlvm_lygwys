...
namespace Mzg.Web.Customize.Models
{
    ...
    public class CreateAttributeModel
    {
        ...
        public decimal? FloatMinValue { get; set; }

        [Range(float.MinValue, float.MaxValue)]
        public decimal? FloatMaxValue { get; set; }
        ...
        [Range(float.MinValue, float.MaxValue)]
        public decimal? MoneyMinValue { get; set; }

        [Range(float.MinValue, float.MaxValue)]
        public decimal? MoneyMaxValue { get; set; }
        ...
        public string filedConditionsExp { get; set; }
    ...
    public class EditAttributeModel
    {
        ...
        public string FilterExpression { get; set; }
        public string filedConditionsExp { get; set; }
        public List<bool> CheckedValue { get; set; }
    }
}