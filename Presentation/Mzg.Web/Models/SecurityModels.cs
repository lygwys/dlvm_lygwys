...
namespace Mzg.Web.Models
{
    ...
    /// 202007181120
    /// </summary>
    public class MultistageModel : BasePaged<MultistageDc>
    {
        public string DisplayName { get; set; }
        ...
        ///
        /// </summary>
        public int ParentMultistageId { get; set; }
    ...
    public class EditMultistageModel
    {
        public Guid? MultistagedcId { get; set; }
