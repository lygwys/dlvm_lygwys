            ...
            get
            {
                if (_privilegeTree == null)
                {
                    ...
                    if (url.IsNotEmpty())
                    {
                        ...
                        /******************************************************
                         * 调用getTreePath方法是要调用接口文件iPrivilegeTreeBuilder中的getTreePath接口具体在PrivilegeTreeBuilder中实现
                         * 获得这个接口并强转为IPrivilegeTreeBuilder类型后调用getTreePath接口
                         * xmg
                         * 20200526
                         * ******************************************************/
                    }
